...
VER;
				...
				if(file_exists(IA_ROOT . '/index.php') && file_exists(IA_ROOT . '/setting.php') && file_exists($verfile)) {
					...
					die('<script type="text/javascript">alert("你正在使用本地安装, 但未下载完整安装包.");history.back();</script>');
	...
	<div class="top">
		...
		<div class="top-link">
			...
			<ul>
				...
				<li><a href="http://weiheshi.taobao.com/" target="_blank">微爱云</a></li>
...
function tpl_install_license() {
	...
	echo <<<EOF
		...
		<div class="pr-agreement">
				...
				<p>版权所有 (c)2015，微爱云保留所有权利。 </p>

				<p>感谢您选择微爱云场景应用</p>

			<strong>本程序由微爱云二次开发，版权所有，侵权必究！</strong>

			<strong>如造成无法访问，概不负责。</strong>

			<strong>本程序基于PHP + SQL 开发，请确保使用PHP5.3版本以上。否则部分功能无法使用。</strong>
...
EOF;
	...
	<table width="726" border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
		...
		<tr>
			...
			<td><input name="dbuser" id="dbuser" type="text" value="root" class="input-txt" />

			<small>您的数据库用户名</small></td>
	...
	<table width="726" border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
		...
		<tr>
			...
			<td>
				...
				<p><small>系统默认管理员账号为：admin，可修改</small></p>
