...
class LxybuildproModuleSite extends WeModuleSite {
...
<panorama id="" hideabout="1">
	...
	public function geturl($type=1)
	{
		...
		{
			case 1:
				$img_url='./source/modules/lxybuildpro/template/img/build_home.png';
				break;
			case 2:
				$img_url='./source/modules/lxybuildpro/template/img/build_banner.png';
				break;
			case 3:
				$img_url='./source/modules/lxybuildpro/template/img/build_house_banner.png';
				break;
			case 4:
				$img_url='./source/modules/lxybuildpro/template/img/YouGotMe.mp3';
				break;
			default:
				$img_url='./source/modules/lxybuildpro/template/img/art_pic.png';
		}
		return $img_url;			
	}
	...
	public function getindexpic($picurl)
	{
		...
		if(empty($picurl))
		{
			$img_url=$_W['siteroot'].'source/modules/lxybuildpro/template/img/index.jpg';
		}
		else 
		{
	...
	public function getdefaultfullviewpic($type,$picurl)
	{
		...
		switch ($type)
		{
			case 1:
				if(empty($picurl))
				{
					$img_url=$_W['siteroot'].'source/modules/lxybuildpro/template/img/qian.jpg';
				}
				else 
				{
					$img_url=$_W['attachurl'].$picurl;
			...
			case 2:
				if(empty($picurl))
				{
				$img_url=$_W['siteroot'].'source/modules/lxybuildpro/template/img/hou.jpg';
				}
				else 
				{
					$img_url=$_W['attachurl'].$picurl;
			...
			case 3:
				if(empty($picurl))
				{
				$img_url=$_W['siteroot'].'source/modules/lxybuildpro/template/img/zuo.jpg';
				}				
				else
				{
					$img_url=$_W['attachurl'].$picurl;
			...
			case 4:
				if(empty($picurl))
				{
				$img_url=$_W['siteroot'].'source/modules/lxybuildpro/template/img/you.jpg';
				}				
				else
				{
					$img_url=$_W['attachurl'].$picurl;
			...
			case 5:
				if(empty($picurl))
				{
					$img_url=$_W['siteroot'].'source/modules/lxybuildpro/template/img/shang.jpg';
				}				
				else
				{
					$img_url=$_W['attachurl'].$picurl;
			...
			case 6:
				if(empty($picurl))
				{
					$img_url=$_W['siteroot'].'source/modules/lxybuildpro/template/img/xia.jpg';
				}				
				else
				{
					$img_url=$_W['attachurl'].$picurl;
