    ...
    getPlayer: function(){
        ...
        $.ajax({
            ...
            success: function(data){
				...
				//$('#rankingNum').html(data.ranking == -1 ? '无' : data.ranking);
...
//        }, 1000)
	...
	setPlayAudio: function(){
		...
		var normalAudios = ['./source/modules/zzz/template/audio/bu.mp3', './source/modules/zzz/template/audio/bloom.mp3', './source/modules/zzz/template/audio/fight.mp3', './source/modules/zzz/template/audio/bu.mp3', './source/modules/zzz/template/audio/XX.mp3', './source/modules/zzz/template/audio/kwdlh.mp3', './source/modules/zzz/template/audio/afs.mp3'];
		var criticalAudios = ['./source/modules/zzz/template/audio/critical.mp3'];
		var winningAudios = ['./source/modules/zzz/template/audio/winning.mp3'];
		var openAudios = ['./source/modules/zzz/template/audio/open.mp3'];
	...
	powerClick: function(el){
		...
		$.ajax({
			...
			success: function(data){
                if (data.success) {
                    _this.powerAnimate(data.result);
					_this.setEnergyCost();
                }
...
//                }
	...
	alert: function(msg, target, close, type, style){
		...
		var dialogType = '<div class="help-mask"><div class="help-mask-bubble"><img src="./source/modules/zzz/template/images/dialog-bg-1.png" border="0" alt=""><span class="help-mask-text" style="{0}">{1}</span></div></div>';
		if(type == 'winning'){
			dialogType = '<div class="help-mask"><div class="help-mask-bubble"><img src="./source/modules/zzz/template/images/dialog-bg-2.png" border="0" alt=""><span class="help-mask-text" style="{0}">{1}</span></div></div>';
		}
