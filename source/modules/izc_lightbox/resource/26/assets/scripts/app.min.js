...
define("modules/app/main", ["lib/zepto/zepto", "lib/zepto/selector", "units/lightAppAd", "lib/zepto/touch", "units/globalAudio", "lib/zepto/coffee", "system/util/objectUtil", "./statistics"],
function(require, exports, module) {
		...
		function() {
			...
			function() {
				h && (h = !1, c ? (b._isDisableFlipPage = !0, a.style.webkitTransition = "-webkit-transform 0.4s ease-out", c.style.webkitTransition = "-webkit-transform 0.4s ease-out", Math.abs(g) > Math.abs(f) && Math.abs(g) > 100 ? (i ? (a.style.webkitTransform = "scale(1)", c.style.webkitTransform = "translateY(0px)") : (a.style.webkitTransform = "scale(1)", c.style.webkitTransform = "translateY(0px)"), setTimeout(function() {
					...
					this.$currentPage = $(c).trigger("current"),
					b._first || $(a).index() != b._$pages.size() - 1 || (b._first = !0)
				},
				500)) : (i ? (a.style.webkitTransform = "scale(1)", c.style.webkitTransform = "translateY(100%)") : (a.style.webkitTransform = "scale(1)", c.style.webkitTransform = "translateY(-100%)"), setTimeout(function() {
					c.classList.remove("z-active"),
					c.classList.remove("z-move"),
					b._isDisableFlipPage = !1
				},
	...
	App.prototype.showPage = function(a) {
		...
		window._app_showPage ? window._app_showPage: window._app_showPage = function(a) {
			...
			b && b.length && (this._$pages.filter(".z-current").removeClass("z-current"), b.css("-webkit-transform", "none").addClass("z-current"), this.$currentPage = b)
		},
		this._isInitComplete ? window._app_showPage.apply(b, [a]) : $(window).one("load",
		function() {
...
define("modules/form/main", ["lib/zepto/zepto", "units/maskLayer", "lib/zepto/selector", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "units/lightAppAd", "units/globalAudio", "modules/app/statistics"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("units/maskLayer"),
		...
		init: function() {
			f.each(function(a, b) {
				...
				if (f.length) {
					...
					function() {
						e.disableFlipPage(),
						d(window).off("scroll.elasticity touchmove.elasticity")
					}),
					k.on("hide",
					function() {
						e.enableFlipPage(),
					...
					$page.delegate(".m-contactUs a", d.isPC ? "click": "click",
					function() {
						k.show()
					}),
					g.delegate("input.z-error", "focus",
					function() {
						var a = d(this);
...
define("modules/link/main", ["lib/zepto/zepto", "lib/zepto/selector", "units/maskLayer", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "units/lightAppAd", "units/globalAudio", "modules/app/statistics"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
		...
		init: function() {
			f.each(function(a, b) {
				...
				if (c.length) {
					...
					f.find("img").on(d.isPC ? "click": "tap",
					function() {
...
define("modules/map/main", ["lib/zepto/zepto", "units/yunlaiMap", "lib/zepto/selector", "lib/zepto/touch", "lib/zepto/data", "http://api.map.baidu.com/getscript?v=1.4&ak=h6rMzpaZgIOMvdzzGEzcGgBk&services=true&t=20140320104737", "modules/app/main", "units/lightAppAd", "units/globalAudio", "modules/app/statistics"],
function(require, exports, module) {
	var $ = require("lib/zepto/zepto"),
	...
	module.exports = {
		init: function() {
			$mapPages.each(function(i, item) {
				...
				$page.find(".m-distributedPoints").delegate(".mapEnter", $.isPC ? "click": "click",
				function(e) {
					var $this = $(this);
					map.show(),
					map.clearOverlays();
					...
					if (markers) for (var markersArr = eval(markers), i = 0; i < markersArr.length; i++) {
						...
						marker.title = marker.name ? marker.name: "",
						marker.content = (marker.tel ? '电话：<a href="tel:' + marker.tel + '">' + marker.tel: "") + (marker.desc ? "</a><br/>" + marker.desc: "") + "<br/>地址：" + (marker.addr ? marker.addr: ""),
						delete marker.name,
						delete marker.tel,
						delete marker.addr,
						delete marker.desc,
						marker.content = marker.content.replace(/(\<br\s*\/\>\s*)+/gi, "<br/>"),
						0 == i ? map.addMarker(marker, !0) : map.addMarker(marker)
					}
				});
...
define("modules/mask/main", ["lib/zepto/zepto", "lib/zepto/data", "./mask", "lib/zepto/touch", "modules/app/main", "lib/zepto/selector", "units/lightAppAd", "units/globalAudio", "modules/app/statistics", "units/widget"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/data"),
	e = a("./mask"),
...
define("modules/mask/mask", ["lib/zepto/zepto", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "lib/zepto/selector", "units/lightAppAd", "units/globalAudio", "modules/app/statistics", "units/widget"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/touch"),
	d = a("lib/zepto/data"),
	...
	g.prototype = d.extend({},
	f, {
		init: function() {
			var a = this;
			this.circle1.on(this.click,
			function() {
				a.touchNum += 1,
				d(this).hide(),
				a.maskAnimationTwo(a, 4, 3, 12, 60,
				function() {
					a.maskAnimationBack(a)
				})
			}),
			this.circle2.on(this.click,
			function() {
				a.touchNum += 1,
				d(this).hide(),
				a.maskAnimationOne(a, 4, 3, 12, 60,
				function() {
					a.maskAnimationBack(a)
				})
			}),
			this.circle3.on(this.click,
			function() {
				a.touchNum += 1,
				d(this).hide(),
				a.maskAnimationThree(a, 4, 3, 12, 60,
				function() {
					a.maskAnimationBack(a)
				})
			})
		...
		maskAnimationBack: function(a) {
			a.touchNum >= 3 && !a.touchFinish && (a.touchFinish = !0, a.touchFinish && e.enableFlipPage(), a.maskAnimation(a, 4, 5, 20, 80,
			function() {
				a.mask.find(".touch-1").hide(),
				a.mask.find(".touch-2").hide(),
				a.mask.find(".touch-3").hide(),
				a.mask.find(".touch-4").css("-webkit-mask", "none!importnat")
			}))
		},
		...
		maskAnimationTwo: function(a, b, c, e, f, g) {
			...
			a.setInterTwo = setInterval(function() {
				h >= b && (h = 0, _y_b = _y_b >= c ? 0 : _y_b += 1),
				a.mask.find(".touch-2").css("-webkit-mask-position", 640 * -h + "px " + -_y_b * d(window).height() + "px"),
				h += 1,
				_i_b++,
				_i_b >= e && (clearInterval(a.setInterTwo), g())
			},
			f)
		},
		maskAnimationThree: function(a, b, c, e, f, g) {
			...
			a.setInterThree = setInterval(function() {
				h >= b && (h = 0, _y_c = _y_c >= c ? 0 : _y_c += 1),
				a.mask.find(".touch-3").css("-webkit-mask-position", 640 * -h - 20 + "px " + -_y_c * d(window).height() + "px"),
				h += 1,
				_i_c++,
				_i_c >= e && (clearInterval(a.setInterThree), g())
			},
			f)
		},
		maskAnimation: function(a, b, c, e, f, g) {
			...
			a.setInter = setInterval(function() {
				h >= b && (h = 0, _y = _y >= c ? 0 : _y += 1),
				a.mask.find(".touch-4").css("-webkit-mask-position", 640 * -h + "px " + -_y * d(window).height() + "px"),
				h += 1,
				_i++,
				_i >= e && (clearInterval(a.setInter), g())
			},
			f)
		}
	}),
...
define("modules/maskSwear/maskSwear", ["lib/zepto/zepto", "lib/zepto/selector"],
function(a) {
	function b(a) {
		a.stopPropagation();
		var b = a.pageX,
		...
		c(this).data("click") || (c(this).data("click", "true"), timer = f && g ? setInterval(function() {
			...
			e.drawImage(i, b - redius / 2, d - redius / 2, redius, redius),
			redius += 2
		},
		.3) : setInterval(function() {
			redius > 300 && clearInterval(timer),
			e.globalCompositeOperation = "destination-out",
			e.drawImage(i, b - redius / 2, d - redius / 2, redius, redius),
			redius += 2
		},
	...
	console.log(g);
	var h = new Image;
	h.src = "/template/26/data/images/modules/maskSwear/bg.png",
	h.onload = function() {
		e.drawImage(h, 0, 0)
	};
	var i = new Image;
		...
		init: function() {
			e.each(function(a, b) {
				...
				function() {
					...
					c.addClass("z-viewArea").find("li:first").addClass("z-current")
				})
			})
		}
	}
}),
define("modules/video/main", ["lib/zepto/zepto", "lib/zepto/touch", "units/maskLayer", "lib/zepto/selector", "lib/zepto/data", "./youkuVideo", "lib/youku/jsapi", "modules/app/main", "units/lightAppAd", "units/globalAudio", "modules/app/statistics", "lib/zepto/coffee", "system/util/objectUtil"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/touch"),
	d = a("units/maskLayer"),
...
define("modules/words/iScroll", ["lib/zepto/zepto", "units/widget"],
function(a, b, c) {
	function d(a, b, c) {
		"undefined" == typeof a ? (this.wrapper = window, this.scroller = document) : "undefined" == typeof b ? (this.wrapper = "string" == typeof a ? document.querySelector(a) : a, this.scroller = this.wrapper.children[0]) : (this.wrapper = "string" == typeof a ? document.querySelector(a) : a, this.scroller = "string" == typeof b ? document.querySelector(b) : b),
		this.eventType = {
			touchstart: 1,
			touchmove: 1,
			touchend: 1,
	...
	f, {
		...
		initEvents: function(a) {
			...
			this.hasTouch ? (b(c, "touchstart", this), b(c, "touchmove", this), b(c, "touchcancel", this), b(c, "touchend", this)) : (b(c, "mousedown", this), b(c, "mousemove", this), b(c, "mousecancel", this), b(c, "mouseup", this)),
		...
		_start: function(a) {
			if (! (1 != this.eventType[a.type] && 0 !== a.button || !this.enabled || this.initiated && this.eventType[a.type] !== this.initiated)) {
				...
				this.initiated = this.eventType[a.type],
				this.moved = !1,
				this.distY = 0,
				this.distX = 0,
				this._transitionTime(),
				...
				this.useTransition && this.isInTransition && (pos = this.getComputedPosition(), this._translate(Math.round(pos.x), Math.round(pos.y)), this.isInTransition = !1),
				this.startX = this.x,
				this.startY = this.y,
				this.pointY = b.pageY,
				this.pointX = b.pageX,
		...
		_move: function(a) {
			if (this.enabled && this.eventType[a.type] === this.initiated) {
				...
				if (this.pointY = f.pageY, this.pointX = f.pageX, this.distY += g, this.distX += h, e = Math.abs(this.distX), d = Math.abs(this.distY), !(i - this.endTime > 300 && 10 > e && 10 > d)) {
					...
					if (this.LockPostion && this.position == this.LockType) this.moved || this._handleEvent("lockFn_start"),
					this.moved = !0;
					else {
						...
						b = this.x + h,
						c = this.y + g;
						var j, k; (b > 0 || b < this.maxScrollX) && (b = this.bounce ? this.x + h / 3 : b > 0 ? 0 : this.maxScrollX, j = b > 0 ? 0 : this.maxScrollX - b),
						(c > 0 || c < this.maxScrollY) && (c = this.bounce ? this.y + g / 3 : c > 0 ? 0 : this.maxScrollY, k = c > 0 ? 0 : this.maxScrollY - c),
						this.moved ? this._handleEvent("move", this.x, this.y, this.maxScrollX, this.maxScrollY, this.wrapper) : this._handleEvent("start"),
						this.moved = !0,
						this._translate(b, c),
						i - this.startTime > 300 && (this.startTime = i, this.startY = this.y)
					}
				}
			}
		},
		_end: function(a) {
			if (this.enabled && this.eventType[a.type] === this.initiated) {
				if (this._handleEvent("end", this.x, this.y, this.maxScrollX, this.maxScrollY, this.wrapper), this.preventDefault && !this._preventDefaultException(a.target, this.preventDefaultException) && a.preventDefault(), this.LockPostion && this.position == this.LockType) Math.abs(this.distX) >= 100;
					...
					e = c.destination, f = b.destination, i = Math.max(c.duration, b.duration), this.isInTransition = 1), e != this.x || f != this.y) return (e > 0 || e < this.maxScrollX || f > 0 || f < this.maxScrollY) && (j = this.ease.quadratic),
					void this.scrollTo(e, f, i, j)
				}
				this.position = !1,
				this.hasPosition = !1
			}
		...
		scrollTo: function(a, b, c, d) {
			...
			!c || this.useTransition && d.style ? (this._transitionTimingFunction(d.style), this._transitionTime(c), this._translate(a, b)) : this._animate(a, b, c, d.fn)
		},
		_transitionTime: function(a) {
			a = a || 0,
			this.scroller.style[this._prefixStyle("transitionDuration")] = a + "ms"
		},
		_transitionTimingFunction: function(a) {
			this.scroller.style[this._prefixStyle("transitionTimingFunction")] = a
		},
		_translate: function(a, b) {
			this.useTransform ? this.scroller.style[this._prefixStyle("transform")] = "translate(" + a + "px," + b + "px)" + this.translateZ: (a = Math.round(a), b = Math.round(b), this.scroller.style.left = a + "px", this.scroller.style.top = b + "px"),
			this.x = a,
			this.y = b
		},
		_transitionEnd: function(a) {
		...
		resetPosition: function(a) {
			...
			e = this.x;
			return a = a || 0,
			!this.hasHorizontalScroll || this.x > 0 ? (e = 0, b = 0) : this.x < this.maxScrollX && (e = this.maxScrollX, b = this.maxScrollX - this.x),
			!this.hasVerticalScroll || this.y > 0 ? (d = 0, c = 0) : this.y < this.maxScrollY && (d = this.maxScrollY, c = this.maxScrollY - this.y),
			e == this.x && d == this.y ? !1 : (this._handleEvent("bounce", b, c, this.wrapper), this.scrollTo(e, d, a, ""), !0)
		}
	}),
	c.exports = d
}),
define("modules/words/main", ["lib/zepto/zepto", "lib/zepto/touch", "lib/zepto/data", "modules/app/main", "lib/zepto/selector", "units/lightAppAd", "units/globalAudio", "modules/app/statistics", "units/widget", "./iScroll"],
function(require, exports, module) {
	var $ = require("lib/zepto/zepto"),
	...
	widget, {
		...
		wallOpen: function() {
			var a = this;
			this.openWallBtn.on(this._click,
			function() {
				a.wordsWall = $(this).parents(".page-words").find(".m-words-wall"),
				a.editWallBtn = a.wordsWall.find(".j-wall-edit"),
				a.editWallTet = a.wordsWall.find(".j-wall-txt"),
				a.editWallInput = a.wordsWall.find(".j-wall-input"),
				a.submitWallBtn = a.wordsWall.find(".j-wall-submit"),
				a.wodrdsDetail = a.wordsWall.find(".m-words-detail"),
				a.wordsWarn = a.wordsWall.find(".m-words-warn"),
				a.plugin = a.wordsWall.data("scroll"),
				a.wallClose(),
				a.wordEdit(),
				a.wordSubmit();
				var b = a.wodrdsDetail.find("ul li").size();
				10 > b && (a.wordsWarn.data("noInfo", "true"), a.wordsWarn.hide()),
				a.wordsWall.show(),
				setTimeout(function() {
		...
		wallClose: function() {
			...
			this.wordsWall.on(this._click,
			function(b) {
				var c = b.target,
				d = $(c); (d.parents(".wrap").length > 0 || d.hasClass("wrap")) && d.parents(".j-wall-close").length <= 0 || (a.wordsWall.removeClass("z-show"), setTimeout(function() {
					a.wordsWall.hide()
				},
		...
		wordEdit: function() {
			...
			this.editWallBtn.on("click",
			function() {
				a.plugin.scrollTo(0, 0),
				a.editWallTet.focus()
			}),
			this.editWallTet.off("focus blur"),
			this.editWallTet.on("focus",
			function() {
				var b = $(this).next("span");
				b.hide(),
				a.plugin.initEvents(!0),
				a.windowStart()
			}),
			this.editWallTet.on("blur",
			function() {
				var b = $(this).next("span");
				b.show(),
			...
			this.editWallInput.on("focus",
			function() {
				a.plugin.initEvents(!0),
				a.windowStart()
			}),
			this.editWallInput.on("blur",
			function() {
				a.plugin.initEvents(!1),
				a.windowStop()
			})
		...
		wordSubmit: function() {
			var that = this;
			this.submitWallBtn.on(this._click,
			function() {
		...
		event: function(a, b) {
			...
			function() {
				app.disableFlipPage(),
				b.wordsWall && (b.wordsWall.find("input").blur(), b.wordsWall.find("textarea").blur())
			}),
			a._on("end",
			function(a, c, d, e) {
				if ("true" != b.wordsWarn.data("noInfo")) {
					...
					if (d - a >= 50 || e - c >= 50) {
						...
						b.plugin.refresh(f),
						b.wordsWarn.find(".warn-txt").hide(),
						b.wordsWarn.find(".warn-loading").show(),
						b.loadMoreCommend(b)
					} else b.wordsWarn.data("loading", "false"),
					b.plugin.refresh(f - 60)
				}
			}),
			a._on("move",
			function(a, c, d, e, f) {
			...
			$.ajax({
				...
				success: function(msg) {
					if (msg.success) {
						...
						data.length < 10 && (obj.wordsWarn.data("noInfo", "true"), obj.wordsWarn.hide())
					} else {
						...
						obj.showCheckMessage($(".u-note"), "提交失败!", !1)
					}
					obj.wordsWarn.data("loadMore", "false"),
					obj.wordsWarn.data("loading", "false");
					var height = obj.plugin.scroller.offsetHeight;
				...
				error: function() {
					...
					obj.plugin.refresh(a - 60),
					obj.showCheckMessage($(".u-note"), "errorThrown!", !1)
				}
			})
		},
...
define("page/main", ["modules/app/main", "lib/zepto/zepto", "lib/zepto/selector", "units/lightAppAd", "units/globalAudio", "modules/app/statistics", "modules/index/main", "modules/index/animationCloudBg", "modules/index/meteorShower", "modules/teletext/main", "modules/teletext/cascadingTeletext", "modules/link/main", "units/maskLayer", "modules/video/main", "lib/zepto/touch", "modules/video/youkuVideo", "modules/map/main", "units/yunlaiMap", "modules/form/main", "modules/words/main", "lib/zepto/data", "units/widget", "modules/words/iScroll", "modules/mask/main", "modules/mask/mask"],
function(a) {
	a("modules/app/main");
	...
	a("modules/words/main").init(),
	a("modules/mask/main").init(),
	$(".page").first().trigger("current"),
	console.log("\n运行成功！"),
...
function(a, b, c) {
	...
	f = function(a) {
		...
		this._$globalAudio.coffee({
			steams: ['<img src="./source/modules/izc_lightbox/resource/22/source/styles/img/musicalNotes.png"/>', '<img src="./source/modules/izc_lightbox/resource/22/source/styles/img/musicalNotes.png"/>', '<img src="./source/modules/izc_lightbox/resource/22/source/styles/img/musicalNotes.png"/>', '<img src="./source/modules/izc_lightbox/resource/22/source/styles/img/musicalNotes.png"/>', '<img src="./source/modules/izc_lightbox/resource/22/source/styles/img/musicalNotes.png"/>', '<img src="./source/modules/izc_lightbox/resource/22/source/styles/img/musicalNotes.png"/>'],
			steamHeight: 100,
			steamWidth: 50
		}),
...
define("units/lightAppAd", ["lib/zepto/zepto", "lib/zepto/touch"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/touch"),
	e = function() {
	...
	e.prototype._init = function() {
		...
		if (d(".m-lightAppAd").length <= 0) {
			a.$lightAppAd = d('<div class="m-lightAppAd"> </div>'),
			...
			d(".m-lightAppAd-body").find("a").on("click",
			function(a) {
				a.preventDefault()
			}),
			b.on(d.isPC ? "click": "click",
			function(b) {
			...
			a.$lightAppAd.on(d.isPC ? "click": "click",
			function() {
...
define("units/tip", ["lib/zepto/zepto", "lib/zepto/animationShow"],
function(a, b, c) {
	function d() {
		this._$tipTemplate = e('<div class="u-tip"><i></i><p>{content}</p></div>'),
		this._$body = e("body")
	}
	var e = a("lib/zepto/zepto");
	e = a("lib/zepto/animationShow"),
...
function(a, b, c) {
	var d = function() {
		...
		this.hasTouch = "ontouchstart" in window ? !0 : !1,
		this._events = {},
		this._isMotion = !!window.DeviceMotionEvent,
		this._elementStyle = document.createElement("div").style,
		this._UC = RegExp("Android").test(navigator.userAgent) && RegExp("UC").test(navigator.userAgent) ? !0 : !1,
		this._weixin = RegExp("MicroMessenger").test(navigator.userAgent) ? !0 : !1,
		this._iPhoen = RegExp("iPhone").test(navigator.userAgent) || RegExp("iPod").test(navigator.userAgent) || RegExp("iPad").test(navigator.userAgent) ? !0 : !1,
		this._Android = RegExp("Android").test(navigator.userAgent) ? !0 : !1,
		this._IsPC = function() {
	...
	d.prototype = {
		...
		momentum: function(a, b, c, d, e) {
			...
			i = Math.abs(h) / c,
			j = .001;
			return f = a + i * i / (2 * j) * (0 > h ? -1 : 1),
			g = i / j,
			d > f ? (f = e ? d - e / 2.5 * (i / 8) : d, h = Math.abs(f - a), g = h / i) : f > 0 && (f = e ? e / 2.5 * (i / 8) : 0, h = Math.abs(a) + f, g = h / i),
			{
...
define("units/yunlaiMap", ["lib/zepto/zepto", "lib/zepto/selector", "lib/zepto/touch", "lib/zepto/data", "http://api.map.baidu.com/getscript?v=1.4&ak=h6rMzpaZgIOMvdzzGEzcGgBk&services=true&t=20140320104737"],
function(a, b, c) {
	var d = a("lib/zepto/zepto"),
	d = a("lib/zepto/selector"),
	d = a("lib/zepto/touch"),
	...
	function() {
		...
		b = function(b, c) {
			...
			this._$mapRoutePanel = d('<div class="mapRoutePanel"><div id="routeResult_' + this._mapID + '" class="routeResult"><p class="noRouteInfo">暂无路线信息！</p></div><a href="javascript:void(0);" class="toggle"></a></div>'),
			this._baiduMap = null,
			this.markers = [],
		...
		b.prototype.addMarker = function(a) {
			...
			function() {
				...
				b._baiduMap.infoWindow && !b._yunlaiMap_initRouted && (b._yunlaiMap_initRouted = !0, d(b._baiduMap.infoWindow.contentMain).delegate(".navigationButtons a", "click",
				function() {
			...
			window._yunlaiMap_addMarker_timeout = setTimeout(function() {
				...
				1 == b.markers.length && e.dispatchEvent("click"),
				e.openInfoWindow(f)
			},
			200),
			e
