	...
	lazy_img : function(){
		...
		lazyNode.each(function(){
			...
			if(self.is('img')){
				...
				self.css({
					'background-image'	: 'url(./source/modules/showimage/template/image/loading_large.gif)',
...
option_wx.title = $$('#r-wx-title').val();
option_wx.img = $$('#r-wx-img').val();
option_wx.con = $$('#r-wx-con').val();

$$(document.body).wx(option_wx);
