...
document.writeln("");
document.writeln(".windowbody {");
document.writeln("position:absolute;z-index:9999;display:none;width:100%;height:100%;}")
...
document.writeln("<div id=\"windowbody\" class=\"windowbody\">");
...
function alert(content,autoClose){ 
    $("#windowbody").show();
$("#windowcenter").slideToggle("slow"); 
$("#txt").html(content);
if(autoClose){
    $("#windowclosebutton").hide();
   setTimeout('$("#windowcenter").slideUp(500)',8000);    
}

} 
function alert_open(content){ 
    $("#windowbody").show();
$("#windowcenter").show();
$("#txt").html(content);
$("#windowclosebutton").hide();
