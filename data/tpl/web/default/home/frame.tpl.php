...
<title><?php  if(empty($_W['setting']['copyright']['sitename'])) { ?>微爱云 - 微场景专用管理平台<?php  } else { ?><?php  echo $_W['setting']['copyright']['sitename'];?><?php  } ?></title>
	...
	<style>
	#navigation #brand {
		background: url("./resource/mstyle/img/logo.png") no-repeat;
	}
	</style>
    </head>
     <body class="body">
    ...
    <div id="navigation">
        <div class="container-fluid">
            ...
            <ul class='main-nav'>
				...
				<li <?php  if($do=='global') { ?>class='active'<?php  } ?>><a href="./index.php?do=global" target="_self">系统管理</a></li>
				<li>
                    ...
                    <ul class="dropdown-menu">
						<li><a href="http://weiheshi.taobao.com/?p=192" target="_blank">使用指导</a></li>
						<li><a href="http://weiheshi.taobao.com/" target="_blank">获取最新版本</a></li>
                    </ul>
                </li>
				<li>
					<a href="javascript:void(0)" data-toggle="dropdown" class='dropdown-toggle' data-hover="dropdown">
            ...
            <div class="user">
                ...
                <div class="dropdown ">
                    ...
                    <ul class="dropdown-menu pull-right">
						<li>
						    <a href="./account.php?act=display&" target="mainFrame">选择公共号</a>
						</li>
						<li>
        ...
        <div id="left" style="top:2px;">
			...
			<div id="footer_code">
				...
				<div class="contact-service">
					<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=10197432&amp;site=qq&amp;menu=yes" target="_blank" class="" title="在线客服">
						<i class="index-icon-comments-alt"></i>在线客服
					</a>
				</div>
				<div class="contact-phone"><i class="index-icon-phone"></i>18647869197</div>
				<img src="./resource/mstyle/img/gz.jpg">
    ...
    <script>P.skn();</script>
 	...
 	<div style="width:100%;text-align:center;font-size:14px;color:#ff0000;display:none;">微爱云</div>
	</body>
	<script>
